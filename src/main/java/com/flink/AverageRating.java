...
public class AverageRating
{
    public static void main(String[] args) throws Exception
    {
        ...
        DataSet<Tuple3<Long, String, String>> movies =  env.readCsvFile("D:\\workspace\\flink\\SamplePOC\\samplestreamflinkpoc\\ml-latest-small\\movies.csv")
                .ignoreFirstLine()
                .parseQuotedStrings('"')
                .ignoreInvalidLines()
                .types(Long.class, String.class, String.class);

        DataSet<Tuple2<Long, Double>> ratings = env.readCsvFile("D:\\workspace\\flink\\SamplePOC\\samplestreamflinkpoc\\ml-latest-small\\ratings.csv")
                .ignoreFirstLine()
        ...
        List<Tuple2<String, Double>> distribution = movies.join(ratings)
                ...
                .with(new JoinFunction<Tuple3<Long, String, String>, Tuple2<Long, Double>, Tuple3<String, String, Double>>()
                {
                                                                ...
                                                                Tuple2<Long, Double> rating) throws Exception
                    {
                        ...
                        String genere = movie.f2.split("\\|")[0];
                        Double score = rating.f1;
                        return new Tuple3<>(name, genere, score);
                    }
                })
                .groupBy(1)
